...
Replace this section with the supported versions for `actiondeck`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `actiondeck` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in actiondeck.
